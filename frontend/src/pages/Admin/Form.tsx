...
import { SelectType, ItemCreateType, TagTypes, FormPropType } from "../../types/types";
    ...
    return (
        <div className="formCont">
            ...
            <div style={{ alignSelf: "flex-start" }}>
                <FoodImg register={register} setValue={setValue} imgPreview={defaultValues?.imageUrl}/>
                {errors.imageUrl && (
            ...
            <input
                ...
                type="submit"
                value={isLoading ? "Uploading..." : (isLoading && formType === 'U') ? "Update" : "Upload"}
                disabled={isLoading}
            />
            </form>
      </div>
